"""Create Unmapped Controls for SAMS001 PAs that are missing them."""
import psycopg2, os
...
# Now remap controls for SAMS001
cur.execute("""
...
conn.commit()
print(f"Created {created} Unmapped Controls for SAMS001")
print(f"Cleared {deleted} old mappings, re-mapped {mapped} controls")
