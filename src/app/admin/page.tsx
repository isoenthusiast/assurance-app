    ...
    {deleteAssessmentTarget && (
      <div className="fixed inset-0 z-50 flex items-center justify-center bg-slate-900/60">
        <div className="w-full max-w-lg rounded-xl border border-slate-200 bg-white p-6 shadow-2xl">
          ...
          <p className="text-sm text-red-600 font-medium mb-4">This will permanently delete ALL related data:</p>
          <div className="mb-4 space-y-1 text-sm">
            <div className="flex justify-between border-b border-slate-100 py-1"><span className="text-slate-700">Cascade-deleted (automatic):</span></div>
            ...
            <div className="flex justify-between border-b border-slate-100 pt-2 py-1"><span className="text-slate-700">Also cleaned up:</span></div>
          ...
          {deleteAssessmentError && <p className="text-sm text-red-600 mb-3 bg-red-50 px-3 py-2 rounded">{deleteAssessmentError}</p>}
